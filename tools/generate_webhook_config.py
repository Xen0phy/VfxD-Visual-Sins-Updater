#!/usr/bin/env python3
"""
Generates src/integration/webhook_config.h from the vfxd-sins-report-relay Worker's
URL, XOR-obfuscated with the same fixed key webhook_report.cpp decodes with at runtime (see
...
def main():
    if len(sys.argv) != 2:
        print("usage: generate_webhook_config.py <webhook-url>", file=sys.stderr)
        sys.exit(1)
    ...
    print("//################################################################################")
    print("// webhook_config.h")
    print("//--------------------------------------------------------------------------------")
    print("// kWebhookUrlXor      XOR-obfuscated relay URL bytes")
    print("// kWebhookUrlXorLen   byte length of kWebhookUrlXor")
    print("//--------------------------------------------------------------------------------")
    print("// Generated by tools/generate_webhook_config.py -- do not hand-edit. This")
    print("// file is gitignored (see .gitignore) and must never be committed. See")
    print("// webhook_config.example.h for the committed template/instructions this")
    print("// was produced from.")
    print("//--------------------------------------------------------------------------------")
    print()
    print("#pragma once")
    print()
