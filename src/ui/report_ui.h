...
// ---------------------------------------------------------------------------
// "Report an Effect" options-panel section, split out of addon.cpp.
// Pairs with report.h the same way
// addon.cpp used to: report.h/.cpp own validation and the actual network
// send, this file owns the form widgets and composing each GUID's
